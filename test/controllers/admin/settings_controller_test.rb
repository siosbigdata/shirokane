...
class Admin::SettingsControllerTest < ActionController::TestCase
  ...
  test "should create admin_setting" do
    assert_difference('Admin::Setting.count') do
      post :create, admin_setting: { name: @admin_setting.name, parameter: @admin_setting.parameter, title: @admin_setting.title }
    end
  ...
  test "should update admin_setting" do
    patch :update, id: @admin_setting, admin_setting: { name: @admin_setting.name, parameter: @admin_setting.parameter, title: @admin_setting.title }
    assert_redirected_to admin_setting_path(assigns(:admin_setting))
  end
