...
class Admin::GraphsControllerTest < ActionController::TestCase
  ...
  test "should create admin_graph" do
    assert_difference('Admin::Graph.count') do
      post :create, admin_graph: { name: @admin_graph.name, term: @admin_graph.term, title: @admin_graph.title, analysis_type: @admin_graph.analysis_type, graph_type: @admin_graph.graph_type, x: @admin_graph.x, y: @admin_graph.y }
    end
